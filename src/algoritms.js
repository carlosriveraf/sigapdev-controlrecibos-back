...
function insertNewCollectionAlumnoPrograma(req, res, next) {
    let jsonR = req.body;
    let va =
        "('" +
        jsonR.cod_alumno +
        ...
        jsonR.correo +
        "','" +
        jsonR.correo_personal +
        "','" +
        jsonR.telefono_movil +
        "','" +
        jsonR.telefono +
        "','" +
        jsonR.ecivil_id +
        "')";
    q.InsertQueryAlumnoPrograma(req, res, next, va);
}
...
/* Delete alumno_programa */
function fndeleteAlumno(req, res, next) {
    let jsonR = req.body;
    let cod_alumno = jsonR.cod_alumno;

    q.DeleteQueryAlumnoPrograma(req, res, next, cod_alumno);
}


function updateAlumno(req, res, next) {
    let cod_alumno = "'" + req.body.cod_alumno + "'",
        ape_paterno = "'" + req.body.ape_paterno + "'",
        ape_materno = "'" + req.body.ape_materno + "'";
    nom_alumno = "'" + req.body.nom_alumno + "'";
    cod_tip_ingreso = "'" + req.body.cod_tip_ingreso + "'";
    cod_situ = "'" + req.body.cod_situ + "'";
    cod_perm = "'" + req.body.cod_perm + "'";
    anio_ingreso = "'" + req.body.anio_ingreso + "'";
    dni_m = "'" + req.body.dni_m + "'";
    id_programa = "'" + req.body.id_programa + "'";
    correo = "'" + req.body.correo + "'";
    correo_personal = "'" + req.body.correo_personal + "'";
    telefono_movil = "'" + req.body.telefono_movil + "'";
    telefono = "'" + req.body.telefono + "'";
    ecivil_id = "'" + req.body.ecivil_id + "'";
    q.UpdateQueryAlumnoPrograma(req, res, next, cod_alumno, ape_paterno, ape_materno, nom_alumno, cod_tip_ingreso, cod_situ, cod_perm, anio_ingreso, dni_m, id_programa, correo, correo_personal, telefono_movil, telefono, ecivil_id);
...
function getAlumno(req, res, next) {
    let codAlumno = req.params.id;
    q.GetAlumno(req, res, next, codAlumno);
}
...
function getDataEstadoCivil(req, res, next) {
    q.getListaEstadoCivil(req, res, next);
}

function getDataTipoIngreso(req, res, next) {
    q.getListaTipoIngreso(req, res, next);
}

function getDataSituaciones(req, res, next) {
    q.getListaSituaciones(req, res, next);
}

function getDataPermanencia(req, res, next) {
    q.getListaPermanencia(req, res, next);
}
...
module.exports = {
    ...
    insertNewCollectionAlumnoPrograma: insertNewCollectionAlumnoPrograma,
    fndeleteAlumno: fndeleteAlumno,
